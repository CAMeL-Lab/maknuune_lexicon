...
\fancyfoot[R]{{\normalfont\fontsize{15}{15}\selectfont \textbf{v1.0.4}}}}
...
\vspace{5mm}
Finally, whenever \textsc{ph.} appears after a bullet, then the following entry is a phrase (collocation, saying, multiword expression, etc.)
